...
public class ImportantQuestionsTest {
    ...
    @Test
    public void checkQuestionsFirefox() throws Exception {
        webDriver = WebDriverFactory.getWebDriver(WebDriverFactory.BrowserType.FIREFOX);
        webDriver.get(MyConfiguration.PAGE_URL);
        checkQuestions();
    }

    @Test
    public void checkQuestionsChrome() throws Exception {
        webDriver = WebDriverFactory.getWebDriver(WebDriverFactory.BrowserType.CHROME);
        webDriver.get(MyConfiguration.PAGE_URL);
        checkQuestions();
    }
